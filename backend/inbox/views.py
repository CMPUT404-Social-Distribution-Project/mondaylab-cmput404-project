...
from re import T
from like.Serializers import LikeAuthorSerializer, LikePostSerializer
...
class InboxAllApiView(GenericAPIView):
    ...
    get all types , like -follow-comment-post
    """
    #permission_classes = [IsAuthenticated]
    fr_serializer_class = FriendRequestSerializer
    ...
    def get(self, request, author_id):
        ...
        if not isAuthorized(request, author_id): 
            ...
            like_serializer = self.lk_serializer_class(list(inbox.likes.all()), many=True)
